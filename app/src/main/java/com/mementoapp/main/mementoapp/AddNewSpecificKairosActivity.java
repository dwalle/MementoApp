...
public class AddNewSpecificKairosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_new_specific_kairos);

        InitializeAPI();

        Bundle bundle = getIntent().getExtras();
        String passed_name = bundle.getString("name");

        Button btnEnroll = (Button) findViewById(R.id.btn_ActivityAddNewSpecificKairos_Enroll);
        Button btnPhoto = (Button) findViewById(R.id.btn_ActivityAddNewSpecificKairos_Photo);
        this.imageView = (ImageView)this.findViewById(R.id.imageView_ActivityAddNewSpecificKairos);
        tfSubjectID = (EditText) findViewById(R.id.editText_ActivityAddNewSpecificKairos_PersonName);
        tfMessage = (TextView) findViewById(R.id.txtView_ActivityAddNewSpecificKairos_KairosMessage);


        tfSubjectID.setText(passed_name);
        ...
        */
        ...
        call.enqueue(new Callback<KairosResponse_Enroll>() {
            ...
            public void onFailure(Call<KairosResponse_Enroll> call, Throwable t) {
                Toast.makeText(AddNewSpecificKairosActivity.this, "FAILURE! Call: "+call.toString(), Toast.LENGTH_LONG).show();
                t.printStackTrace();
            }
        });
    }
